...
def _get_bot_age_string():
    age_in_minutes = (datetime.datetime.now() - BOOT_TIME).seconds // 60
    return f"I have been alive for {age_in_minutes} minutes."
...
commands = {
    "system": {
        ...
        "open_browser": {
            ...
            "args": [{"name": "url", "description": "The URL of the website to open."}],
